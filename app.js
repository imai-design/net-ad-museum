...
const EXHIBITS = [
  ...
  {
    id: "tokyogas-kizuna",
    yearNum: 2008, year: "2008〜",
    brand: "東京ガス",
    title: "家族の絆シリーズ",
    cats: ["Web/TV", "シリーズ"],
    videoId: "",
    searchQuery: "東京ガス 家族の絆 お弁当メール CM",
    summary: "母と受験生の息子、父子、祖母など、家族の食卓を題材にした実写ドラマ仕立ての企業CMシリーズ。「お弁当メール」では、受験を控えた息子に母が毎日弁当を作り続け、空になって返る弁当箱が無言の対話になる。企業ロゴは最後にわずかに出すだけに抑えている。",
    why: "2008年開始の長寿シリーズで、毎年「泣ける」と話題に。「お弁当メール」はフジサンケイグループ広告大賞テレビ最優秀賞、「やめてよ」はACC TOKYO CREATIVITY AWARDSフィルム部門ゴールドを受賞。商品を売り込まず家族の物語で心を動かす、日本的な共感型CMの代表格。",
    learn: { kw: "ストーリーテリング コピーライティング 書籍", label: "共感の物語を学ぶ" },
  },
  {
    id: "toyota-doraemon",
    yearNum: 2011, year: "2011〜",
    brand: "トヨタ自動車",
    title: "ReBORN ドラえもん（実写）",
    cats: ["シリーズ", "Web/TV"],
    videoId: "",
    searchQuery: "トヨタ ReBORN ドラえもん 実写 ジャン・レノ",
    summary: "「ドラえもん」の登場人物の“20年後”を実写で描いた企業CMシリーズ。ドラえもんをジャン・レノが、30歳で運転免許を持たないのび太を妻夫木聡が演じ、しずか（水川あさみ）やスネ夫（山下智久）らも大人になって登場する。",
    why: "「FUN TO DRIVE, AGAIN.」を掲げたReBORNキャンペーンの目玉。国民的キャラの大胆な実写化が話題を呼び、ドラえもん篇はACCゴールドを受賞した（同年のACCグランプリ＝総務大臣賞は同キャンペーンの東北ドライブ篇）。",
    learn: { kw: "ブランディング 企業広告 戦略 書籍", label: "企業広告の発想を学ぶ" },
  },
  {
    id: "ana-isjapancool",
    yearNum: 2012, year: "2012〜",
    brand: "ANA（全日本空輸）",
    title: "IS JAPAN COOL?",
    cats: ["海外向け", "インタラクティブ"],
    videoId: "RNtnsclAY1Q",
    searchQuery: "ANA IS JAPAN COOL 公式",
    summary: "日本の文化やトレンド（KAWAII、道＝DOU、WABI-SABIなど）を高品質な動画と記事で英語発信し、閲覧者が「Cool / Not so cool」を投票できる訪日プロモーションのWebプラットフォーム。震災後に落ち込んだ訪日需要の喚起を狙った。",
    why: "数年にわたりシリーズ化し、日本のゲーム文化を扱った派生作「GAME CHRONICLE」はカンヌライオンズ2021でブロンズを受賞。航空会社が“旅の前の体験”をデジタルで設計した先駆例。",
    learn: { kw: "ブランデッドコンテンツ コンテンツマーケティング 書籍", label: "ブランデッドコンテンツを学ぶ" },
  },
  {
    id: "pocky-guinness",
    yearNum: 2012, year: "2012〜2013",
    brand: "江崎グリコ（ポッキー）",
    title: "ポッキーの日 Twitterギネス世界記録",
    cats: ["参加型", "SNS"],
    videoId: "",
    searchQuery: "ポッキー ポッキーの日 ギネス世界記録 Twitter",
    summary: "「1」が並ぶ11月11日「ポッキー＆プリッツの日」に合わせ、Twitterで“ポッキー”を含む投稿を呼びかけた参加型キャンペーン。マス広告ではなく、ユーザーの投稿そのものを24時間で積み上げ、ギネス世界記録に挑んだ。",
    why: "「24時間で最もツイートされたブランド」としてギネス世界記録を達成。2013年11月11日には約371万ツイートを記録し、当時の元日「あけおめ」を上回る規模に。広告を“みんなで作る記録”に変えた一手。",
    learn: { kw: "SNSマーケティング バイラル 拡散 書籍", label: "SNS拡散の設計を学ぶ" },
  },
  {
    id: "meiji-kinotake",
    yearNum: 2018, year: "2018〜2020",
    brand: "明治",
    title: "きのこの山・たけのこの里 国民総選挙",
    cats: ["参加型", "SNS"],
    videoId: "",
    searchQuery: "明治 きのこの山 たけのこの里 国民総選挙",
    summary: "長年ネタにされてきた「きのこの山 vs たけのこの里、どっち派？」という論争を、明治自らが公式の投票キャンペーンに仕立てた。商品購入＋WEB/ハガキで「きのこ党」「たけのこ党」に投票させ、2020年は“どれだけ好きか”を問う「国民大調査」へ発展させた。",
    why: "2018・2019年の2回で合計2,600万票超を集め、結果は1勝1敗。SNSでは芸能人までが党派を表明し、ファン同士の“争い”をブランドの祭りに変えた。論争を公式が引き受けた参加型マーケティングの好例。",
    learn: { kw: "ファンマーケティング 参加型 ブランディング 書籍", label: "参加型キャンペーンを学ぶ" },
  },
  {
    id: "pantene-kamigata",
    yearNum: 2019, year: "2019",
    ...
    cats: ["社会派", "賛否両論"],
    videoId: "",
    searchQuery: "パンテーン この髪どうしてダメですか HairWeGo",
    summary: "ブランドメッセージ「#HairWeGo さあ、この髪でいこう。」の一環として、髪型校則や「地毛証明書」という日本の慣習を問い直したソーシャルキャンペーン。生徒と先生が校則について本音で対話する動画やハッシュタグ、新聞広告で社会的議論を喚起した。",
    why: "カンヌライオンズ2020/2021のPR部門でシルバー・ブロンズ、PRアワードグランプリ2019でゴールドを受賞。商品の機能ではなく“個性の尊重”という社会的メッセージを軸に、当事者の声を可視化して世論を動かした。",
    learn: { kw: "PR ソーシャルグッド ブランディング 書籍", label: "社会派PRを学ぶ" },
  },
  {
    id: "nike-future",
    yearNum: 2020, year: "2020",
    brand: "ナイキ（NIKE JAPAN）",
    title: "動かしつづける。自分を。未来を。",
    cats: ["社会派", "賛否両論"],
    videoId: "",
    searchQuery: "ナイキ 動かしつづける 自分を 未来を The Future Isn't Waiting",
    summary: "差別やいじめ、周囲との違いに悩む3人の10代の少女が、サッカーを通じて自分らしさを取り戻していく約2分のWebフィルム。アスリートの実体験に着想を得て、日本で正面から語られにくい出自・人種をめぐるテーマに直球で踏み込んだ。",
    why: "YouTube Works Awards 2021でグランプリとForce for Good部門を受賞。一方で「日本を差別社会として描いている」との猛反発と称賛が衝突し、賛否両論の大論争に。広告がどこまで社会に踏み込むべきかを問うた一作。",
    learn: { kw: "ブランドパーパス 広告 社会 リスク 書籍", label: "ブランドの社会的発信を学ぶ" },
  },
];
